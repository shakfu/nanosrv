...
# ---------------------------------------------------------------------------
# C++ server (nanosrv-server / nanosrv-sharded)
# ---------------------------------------------------------------------------

SERVER_BUILD_DIR := build/cmake

server-build:
	cmake -B $(SERVER_BUILD_DIR) -S projects
...
help:
	...
	@echo ""
	@echo "C++ server targets:"
	@echo "  server-build   - Build nanosrv-server and nanosrv-sharded via CMake"
	@echo "  server-run     - Build and run nanosrv-server"
	@echo "  server-test    - Build and run C++ tests via ctest"
	@echo "  server-clean   - Remove CMake build directory"
	@echo ""
	@echo "Other targets:"
