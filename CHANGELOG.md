...
- `scripts/bench_freethreading.py` and `scripts/loadgen.c`: a dependency-free benchmark of GIL vs free-threaded scaling. The load generator is C because a Python client would contend for the very GIL under test
